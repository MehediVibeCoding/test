        ...
        <form onSubmit={handleSubmit} className="glass-panel space-y-4 p-6 md:p-8">
          <div>
            ...
            <input
              name="name"
              required
              className="w-full rounded-lg border border-sky-100 bg-white/70 px-4 py-2 text-sm outline-none focus:border-sky-600"
          ...
          <button
            type="submit"
            className="w-full rounded-full bg-sky-600 px-6 py-3 text-sm font-medium text-white hover:bg-sky-700 transition-colors"
          >
            ফর্ম জমা দাও
          </button>
        </form>
